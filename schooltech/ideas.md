...
##### 1. Резидентство и команда РШТ
- Обсуждение резидентства в РШТ
- Создание команды вокруг РШТ
- Разработка вертикальной модели вовлечения

##### 2. Модель вовлечения участников
**Вертикальная модель:**
- После базового уровня → переход в чат выпускников
- Группы продолжают существовать долгое время после выпуска

##### 3. Роль РШТ
- Предложение проектов для реализации
- Поиск людей для выполнения проектов
- Форматы взаимодействия:
  - Установочные встречи ("Вы лучшие")
  - Создание карточек-визиток
  - Включение в интересные проекты
  - Предоставление ресурсов

##### 4. Форматы работы с участниками
- Выпускники с прицелом на проведение профильных смен
- Участие в проектах как основная форма работы
- Варианты пребывания в РШТ:
  - Гость учреждения под присмотром педагога
  - Долгосрочное сопровождение педагогом
- Платные услуги:
  - Мастер-классы
  - Платные курсы
  - Работа с оборудованием

##### 5. Два ключевых сообщества
...
**Сообщество текущих учеников**

#### 6. Ресурсы РШТ
- Перечень ресурсов для реализации проектов
- Направление продаваемости услуг
- Идеи:
  - "Письма счастья" (приглашения)
  - Доска почета

#### Action Points
1. **Сообщества:**
   - Определить формат взаимодействия (Telegram-чат)
   - Разделить на сообщества учеников и выпускников

2. **Описание функционала:**
   - Составить список фич сообщества
   - Описать предоставляемые возможности

3. **База участников:**
   - Составить список людей для приглашения
   - Начать с уже обсуждавшихся кандидатур

4. **Процедуры:**
   - Описать порядок вступления (официальный статус)
   - Найти энтузиаста для поддержки сообщества

5. **Координация:**
   - Поговорить с Катей о ведении сообщества
   - Продумать онлайн/офлайн форматы работы
